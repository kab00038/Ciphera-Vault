...
OS quick unlock is optional. It stores the master password in the operating-system credential vault after a successful full-password verification; it is not a claim of biometric enforcement on every platform.
...
crates/ciphera-platform/   OS credential-vault quick unlock
